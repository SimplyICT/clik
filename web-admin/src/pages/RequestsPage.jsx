    ...
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          ...
          <button onClick={() => { alert('BUTTON CLICKED!'); setShowCreate(true); }} style={{ padding: '8px 12px', borderRadius: 4, border: '1px solid #f00', cursor: 'pointer', fontSize: 12 }}>Alert Test</button>
        </div>
      </div>
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', background: '#fff', borderRadius: 8 }}>
        ...
        <tbody>
          {filtered.map(r => (
            <tr key={r.id} style={{ borderBottom: '1px solid #f0f0f0', cursor: 'pointer' }} onClick={() => { alert('ROW CLICKED ' + r.id); setDetail(r); setEditForm(null); }}>
